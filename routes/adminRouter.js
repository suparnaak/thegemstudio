...
router.patch("/users/block/:id", adminAuth, usersController.blockUser);
router.patch("/users/unblock/:id", adminAuth, usersController.unblockUser); 
...
router.patch("/brands/block/:id", adminAuth,brandController.blockBrand);
router.patch("/brands/unblock/:id", adminAuth,brandController.unblockBrand);
router.get("/brands/edit/:id", adminAuth,brandController.loadEditBrand); 
router.patch("/brands/edit/:id", adminAuth, brandController.editBrand); 
...
router.patch("/coupons/delete/:id", adminAuth,couponController.deleteCoupon);
